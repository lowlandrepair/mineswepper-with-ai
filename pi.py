        ...
        for x in range(self.field.field_size[0]):
            if game_over is False and win is False:
                ...
                if self.field.field[x][y].is_flagged:
                    ...
                    flag_points = [
                        (x * self.screen_scale + 10, y * self.screen_scale + 5),  # Bottom left
                        (x * self.screen_scale + 10, y * self.screen_scale + 15),  # Bottom right
                        (x * self.screen_scale + 30, y * self.screen_scale + 10)   # Top point
                    ]
                    self.canvas.create_polygon(flag_points, fill="#FFFF00", outline="#000000")  # Yellow flag with black outline
